...
interface TaxiControlReportModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (data: CreateAlertInput) => Promise<void>;
  /** Tesla / Tab cockpit styling */
  variant?: "tesla" | "app";
}
  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="taxi-control-report-title"
      >
        <button
          type="button"
          onClick={onClose}
        ...
        <label className="mt-5 flex flex-col gap-2">
          ...
          <textarea
            ...
            placeholder={COMMENT_EXAMPLES.join(" · ")}
            rows={3}
          />
          <ul
            className={cn(
