...
export const PROFILE_CORE_COLUMNS =
  "id, display_name, nickname, phone_number, cabradar_user_id, driver_license_last4, verification_status, is_admin, fab_enabled, alert_chime_enabled, created_at, updated_at";
...
const PROFILE_OPTIONAL_GROUPS = [
  ...
  "driver_city, show_national_emergencies, welcome_pending, test_mode_enabled, nickname",
] as const;
...
export function normalizeProfileRow(row: Record<string, unknown>): Profile {
  ...
  return {
    ...
    beta_user: Object.prototype.hasOwnProperty.call(row, "beta_user")
      ...
      : false,
    tesla_beta: Object.prototype.hasOwnProperty.call(row, "tesla_beta")
      ? Boolean(row.tesla_beta)
      : false,
